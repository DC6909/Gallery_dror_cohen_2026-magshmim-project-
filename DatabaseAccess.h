...
{
public:
	DatabaseAccess(std::string dbFileName);
	~DatabaseAccess();
	...
	void removeAllPictureFromAlbum(const std::string& albumName);
	...
	void deleteAllbumsUser(const User& user) override;
	void unTagUserFromAllPicture(const User& user);
